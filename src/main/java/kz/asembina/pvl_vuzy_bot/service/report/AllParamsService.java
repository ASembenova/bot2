...
public class AllParamsService {
    ...
    public AllParamsService(PDFService pdfService, MessageSender messageSender, LocaleService localeService, DataObjectService dataObjectService, CombinationService combinationService, Metadata metadata) {
